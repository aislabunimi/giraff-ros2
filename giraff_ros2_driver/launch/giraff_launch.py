...
def generate_launch_description():
    ...
    giraff = Node (
        ...
        {'base_frame_id': f'{parse_substitution("$(var namespace)")}_base_link'},
        {'odom_frame_id': f'{parse_substitution("$(var namespace)")}_odom'},
        {'stalk_frame_id': f'{parse_substitution("$(var namespace)")}_neck'},
        {'head_frame_id': f'{parse_substitution("$(var namespace)")}_head'},
        {'screen_frame_id': f'{parse_substitution("$(var namespace)")}_screen'},
        {'base_footprint_frame_id': f'{parse_substitution("$(var namespace)")}_footprint'},
        {'camera_frame_id': f'{parse_substitution("$(var namespace)")}_camera'},
        {'laser_frame_id': f'{parse_substitution("$(var namespace)")}_laser_frame'},
