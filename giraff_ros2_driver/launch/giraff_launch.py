...
def generate_launch_description():
    ...
    giraff = Node (
        ...
        {'base_frame_id': f'{parse_substitution("$(var usb_port_up)")}_base_link'},
        {'odom_frame_id': f'{parse_substitution("$(var usb_port_up)")}_odom'},
        {'stalk_frame_id': f'{parse_substitution("$(var usb_port_up)")}_neck'},
        {'head_frame_id': f'{parse_substitution("$(var usb_port_up)")}_head'},
        {'screen_frame_id': f'{parse_substitution("$(var usb_port_up)")}_screen'},
        {'base_footprint_frame_id': f'{parse_substitution("$(var usb_port_up)")}_footprint'},
        {'camera_frame_id': f'{parse_substitution("$(var usb_port_up)")}_camera'},
        {'laser_frame_id': f'{parse_substitution("$(var usb_port_up)")}_laser_frame'},
